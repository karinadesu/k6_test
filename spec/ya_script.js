...
export let options = {
  stages: [
    { duration: '1m', target: 6 }, // simulate ramp-up of traffic from 1 to 6 users over 5 minutes.
    { duration: '2m', target: 6 }, // stay at 6 users for 10 minutes
    { duration: '1m', target: 8 }, // ramp-up to 8 users over 5 minutes 
    { duration: '1m', target: 8 }, // stay at 8 users for for 10 minutes
